...
class ChatInterface(Frame):
    ...
    def __init__(self, master=None):
        ...
        help_option.add_command(label="About MediQuic", command=self.msg)
        ...
        # send button
        self.send_button = Button(self.send_button_frame, text="Send", width=7, height=1, relief=GROOVE, bg='white',
    ...
    def msg(self):
        tkinter.messagebox.showinfo("MediQuic v1.0",
                                    "MediQuic is a chatbot for answering health related queries\nIt is based on retrival-based NLP using pythons NLTK tool-kit module\nGUI is based on Tkinter\nIt can answer user queries like Medice Information, Nearby Hospitals, Knowledge about Therapy, Knowledge about Diseases and its preventions and First Aid Instruction.")

    def about(self):
        tkinter.messagebox.showinfo("MediQuic Developers",
                                    "1.Mohamed Rasith\n2.Mohamed Arsath\n3.Mahath")
...
root.title("MediQuic: The Medical ChatBot")
root.iconbitmap('MediQuic logo.ico')
root.mainloop()